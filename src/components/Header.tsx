    ...
    <header className="border-b border-slate-800 bg-[#060c18]/90 backdrop-blur sticky top-0 z-50 px-6 py-4">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-[#0a1b38] border border-blue-500/50 flex items-center justify-center font-black text-blue-400 shadow-md">
            AL
          </div>
          <div>
            ...
            <p className="text-[11px] text-slate-400">Historial Comparativo Universitario vs. Alianza Lima</p>
          </div>
          <div className="w-9 h-9 rounded-full bg-[#f4ebd0] border border-amber-600/50 flex items-center justify-center font-black text-[#6b1426] shadow-md">
            U
          </div>
        </div>
